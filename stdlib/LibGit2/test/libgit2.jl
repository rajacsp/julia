    ...
    @testset "Update cache repository" begin
        ...
        @testset "with commits" begin
            ...
            try
                ...
                LibGit2.with(LibGit2.GitCommit(repo, commit_oid1)) do cmt
                    ...
                    @test isfound("Git Commit:", showstr[1])
                    @test isfound("Commit Author: Name: TEST, Email: TEST@TEST.COM, Time:", showstr[2])
                    @test isfound("Committer: Name: TEST, Email: TEST@TEST.COM, Time:", showstr[3])
                    @test isfound("SHA:", showstr[4])
        ...
        @testset "blobs" begin
            LibGit2.with(LibGit2.GitRepo(cache_repo)) do repo
                ...
                @test isfound("Blob id:", blob_show_strs[2])
        ...
        @testset "diff" begin
            LibGit2.with(LibGit2.GitRepo(cache_repo)) do repo
                ...
                @test isfound("Oid:", diff_strs[6])
                @test isfound("Path:", diff_strs[7])
                @test isfound("Size:", diff_strs[8])
